...
def crear_mapa_predio_pdf(registro_predio):
    """Crea un mapa Folium centrado en el predio para captura en PDF."""
    ...
    if isinstance(vertices, list) and len(vertices) >= 3:
        ...
        html = (
            ...
            'background:rgba(255,255,255,0.85);border:1px solid #073B5A;'
...
def generar_imagen_predio_png(registro_predio):
    ...
    ax.tick_params(labelsize=7, colors="#52616B")
    ...
    ax.set_title(
        f"Vista cartográfica del predio {registro_predio.get('id_predio', '')}",
        fontsize=12,
        weight="bold",
        color="#073B5A",
    )
