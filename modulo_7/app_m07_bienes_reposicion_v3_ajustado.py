...
def cargar_datos_base():
    ...
    hogares_data = [
        ...
        ("HOG-0011", "Hogar sin paquete 01", "LP-011", "El Nance", "Río Indio", "Zona 2", 9.232, -80.147),
        ("HOG-0012", "Hogar sin paquete 02", "LP-012", "Altos del Río", "Ciricito", "Zona 3", 9.145, -80.121),
        ("HOG-0013", "Hogar prueba sin bienes", "LP-013", "Las Mercedes", "La Encantada", "Zona 1", 9.268, -80.105),
        ("HOG-0014", "Hogar prueba nuevo", "LP-014", "Quebrada Honda", "Río Indio", "Zona 2", 9.181, -80.154),
    ]
    ...
    for i, hogar in hogares.iterrows():
        # Los últimos cuatro hogares quedan sin paquete para pruebas de alta desde cero.
        if i >= 10:
            continue
...
def pantalla_bienes_reposicion():
    ...
    if not paquete:
        st.warning("El hogar seleccionado no tiene paquete de compensación registrado. Este caso queda disponible para pruebas de alta cuando negociación cargue el paquete.")
        return
